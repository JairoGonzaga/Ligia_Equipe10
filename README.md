...
Bash
- OBSERVAÇÃO:
- É necescario o python 3.11+ para poder executar o projeto, com isso se tiver mais de uma versão e não estiver funcionando, por favor especifique a versão do python no comando a baixo, exemplo : python3.11 -m venv .venv
```
python -m venv .venv
```
## No Windows:
